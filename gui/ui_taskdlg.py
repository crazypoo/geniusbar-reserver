...
#
# Created: Mon Dec 01 18:15:13 2014
...
class Ui_TaskDialog(object):
    def setupUi(self, TaskDialog):
        ...
        self.horizontalLayout_12 = QtGui.QHBoxLayout(self.gBTaskProcessinfo)
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.splitter = QtGui.QSplitter(self.gBTaskProcessinfo)
        ...
        self.lEVerfiyCode = QtGui.QLineEdit(self.widget)
        ...
        self.pBOk = QtGui.QPushButton(self.widget)
        ...
        TaskDialog.setTabOrder(self.lEVerfiyCode, self.combStore)
        ...
        TaskDialog.setTabOrder(self.pBCancel, self.pBOk)
        TaskDialog.setTabOrder(self.pBOk, self.lEUserName)
    ...
    def retranslateUi(self, TaskDialog):
        TaskDialog.setWindowTitle(_translate("TaskDialog", "新建任务", None))
