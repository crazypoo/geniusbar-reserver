...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.pBRefresh, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.refresh)
        QtCore.QObject.connect(self.pBSumit, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.submit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pBRefresh.setText(_translate("MainWindow", "刷新", None))
        self.pBSumit.setText(_translate("MainWindow", "确定", None))
