...
#
# Created: Thu Dec 18 11:23:34 2014
...
class Ui_ProxyFinderDLG(object):
    def setupUi(self, ProxyFinderDLG):
        ...
        ProxyFinderDLG.resize(486, 513)
        self.verticalLayout_4 = QtGui.QVBoxLayout(ProxyFinderDLG)
        ...
        self.horizontalLayout_4.addWidget(self.pBImport)
